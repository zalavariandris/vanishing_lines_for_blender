...
def test_scale_by_reference_axes(axis: Literal['X_Axis', 'Y_Axis', 'Z_Axis']):
    ...
    adjusted_view = solver.core.adjust_scale_to_reference_distance(
        ...
        reference_screen_measurement=solver.types.ScreenMeasurement(offset=0, length=0.25),
        view=view
    )
...
def test_scale_by_screen():
    ...
    adjusted_view = solver.core.adjust_scale_to_reference_distance(
        ...
        reference_screen_measurement=solver.types.ScreenMeasurement(offset=0, length=0.5),
        view=view
    )
